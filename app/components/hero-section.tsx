...
export default function HeroSection({
  ...
  return (
    <section
      id="hero"
      ref={sectionRef}
      className="hero-stage relative flex h-screen flex-col justify-center overflow-hidden px-[clamp(24px,5vw,80px)] transition-opacity duration-700"
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 w-full max-w-7xl">
        <div className="pointer-events-auto inline-block">
          ...
          <div className="overflow-hidden">
            <div
              className="mt-6 text-[clamp(14px,2vw,20px)] font-light uppercase tracking-[4px] text-[var(--muted)] transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)] [transition-delay:1.4s]"
              style={{
                opacity: show ? 1 : 0,
      ...
      <div
        className="pointer-events-none absolute bottom-5 left-1/2 flex -translate-x-1/2 flex-col items-center gap-1.5 transition-opacity duration-1000 [transition-delay:1.5s]"
        style={{ opacity: show ? 1 : 0 }}
      >
